    ...
    return (
        ...
        <main className="flex flex-1 flex-col bg-white dark:bg-background p-4 md:gap-4">
            <div className="flex flex-col gap-4  bg-white dark:bg-background">
                <div className="mx-auto grid w-full max-w-6xl pt-1 pb-2">
                    <h1 className="text-2xl font-semibold text-btn">
                ...
                <div className="mx-auto grid w-full max-w-6xl items-start gap-6 bg-white dark:bg-background ">
                    <div className="grid gap-6">
                        <div data-chunk="dashboard-04-chunk-1">
                            <div className="p-4 border border-zinc-400 dark:border-zinc-700 rounded-lg bg-white dark:bg-subbackground">
                            ...
                            <div className="py-2 bg-white dark:bg-background">
                                <div 
                        data-chunk="dashboard-04-chunk-2">
                                    <div className="border border-zinc-400 dark:border-zinc-700 rounded-lg mt-4 p-4 dark:bg-subbackground">
                                        ...
                                        <p className="font-sans text-sm pt-1 opacity-80">
                                            {subscription
                                            ? `Voçe assinou o plano ${subscription?.prices?.products?.name}.`: "Voçe ainda nao assinou nenhum plano."}
                                        </p>
                                    </div>
                                    <div className=" border-zinc-300 dark:border-border pt-2 flex space-between">
                                        <Button
                                 className="bg-background font-bold border text-text"           onClick={handleBillingPortal}
                                            disabled={loading}>
                                            Gerenciar meu plano
                                        </Button>
                                    </div>
