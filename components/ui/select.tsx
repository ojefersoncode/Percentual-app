...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-gray-200 bg-white px-3 py-2 text-sm data-[placeholder]:text-zinc-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-border dark:bg-subbackground dark:ring-offset-none dark:data-[placeholder]:text-zinc-400 dark:focus:ring-none",
      className
    )}
    {...props}
  >
