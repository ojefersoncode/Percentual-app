...
export const HowItWorks = () => {
  return (
    <section id="howItWorks" className="px-4 text-center pt-8 md:pt-14">
      <h2 className="w-full px-4 text-4xl font-bold">
        Por que escolher a{' '}
        <span className="bg-gradient-to-b from-btn to-btn text-white px-2 rounded-lg">
          Cooderfy?
        </span>
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {features.map(({ icon, title, description }: FeatureProps) => (
          <Card
            key={title}
            className="bg-white dark:bg-subbackground border border-zinc-100 dark:border-zinc-700 drop-shadow-md shadow-black/40 dark:shadow-none rounded-lg"
          >
            <CardHeader>
