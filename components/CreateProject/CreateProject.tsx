      ...
      <form>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white dark:bg-background">
          <DialogHeader>
            ...
            >Criar um novo projeto</DialogTitle>
          </DialogHeader>
          <div className="grid gap-4">
            ...
            <div className="grid gap-3 mt-4">
              <Label htmlFor="username-1">Link do repositorio</Label>
          ...
          <DialogFooter className="flex flex-col w-full gap-4 mt-4">
            <DialogClose asChild>
              <Button 
              className="bg-white dark:bg-background dark:text-text border border-zinc-400 dark:border-zinc-700"
              >Cancelar</Button>
            </DialogClose>
            <Button
            className="px-3 py-2 rounded-lg bg-btn dark:bg-btn hover:bg-btn dark:hover:bg-btn text-text dark:text-text"
            type="submit">Criar projeto</Button>
          </DialogFooter>
        </DialogContent>
      </form>
    </Dialog>
